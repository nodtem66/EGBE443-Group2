clear; close all; clc;
%%
addpath(genpath('../Edge detection/LSM file/lsm'))
pic = mylsm_v1('Cntrl1.lsm');
pic = rgb2gray(pic);
lsm_info = imfinfo('Cntrl1.lsm');
%%
[pic Image maxVal] = histEqualization_v1(pic);
%%
...
%%
figure(1)
subplot(3,3,2), imshow(pic,[]), title('Original with Histrogram Equalization')
